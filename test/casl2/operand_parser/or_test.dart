...
import 'package:tiamat/src/casl2/operand_parser/or.dart';
    ...
    group('error', () {
      ...
      for (var i = 0; i < testdata.length; i++) {
        ...
        test('$i', () {
          ...
          expect(or(symbol, tree), isNotNull);
      ...
      for (var i = 0; i < 16; i++) {
        test('$i', () {
          ...
          expect(symbol.nodes.first.code,
              equals(0x3500 | register1 << 4 | register2));
      ...
      group('address only', () {
        for (var i = 0; i < 16; i++) {
          test('$i', () {
            ...
            expect(symbol.nodes[0].code, equals(0x3100 | register << 4));
      ...
      group('address with index', () {
        for (var i = 0; i < 16; i++) {
          test('$i', () {
            ...
            expect(
                symbol.nodes[0].code, equals(0x3100 | register << 4 | index));
            expect(symbol.nodes[0].type, equals(Type.code));
            expect(symbol.nodes[1].code, equals(address));
            expect(symbol.nodes[1].type, equals(Type.code));
          });
