...
import 'package:tiamat/src/casl2/operand_parser/subl.dart';
    ...
    group('error', () {
      ...
      for (var i = 0; i < testdata.length; i++) {
        ...
        test('$i', () {
          ...
          expect(subl(symbol, tree), isNotNull);
    ...
    group('r1,r2', () {
      for (var i = 0; i < 16; i++) {
        test('$i', () {
          ...
          expect(subl(symbol, tree), isNull);
          ...
          expect(symbol.nodes.first.code,
              equals(0x2700 | register1 << 4 | register2));
      ...
      group('address only', () {
        for (var i = 0; i < 16; i++) {
          test('$i', () {
            ...
            expect(symbol.nodes[0].code, equals(0x2300 | register << 4));
      ...
      group('address with index', () {
        for (var i = 0; i < 16; i++) {
          test('$i', () {
            ...
            expect(
                symbol.nodes[0].code, equals(0x2300 | register << 4 | index));
            expect(symbol.nodes[0].type, equals(Type.code));
            expect(symbol.nodes[1].code, equals(address));
            expect(symbol.nodes[1].type, equals(Type.code));
          });
