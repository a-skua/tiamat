...
import 'package:tiamat/src/casl2/instruction/subl.dart';
      ...
      group('address only', () {
        for (var i = 0; i < 16; i++) {
          test('$i', () {
            ...
            expect(root.nodes[0].code, equals(0x2300 | register << 4));
      ...
      group('address with index', () {
        for (var i = 0; i < 16; i++) {
          test('$i', () {
            ...
            expect(root.nodes[0].code, equals(0x2300 | register << 4 | index));
            expect(root.nodes[0].type, equals(Type.code));
            expect(root.nodes[1].code, equals(address));
            expect(root.nodes[1].type, equals(Type.code));
          });
