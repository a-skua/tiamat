...
import 'package:tiamat/src/comet2/instruction/push.dart';
    ...
    group('adr,x', () {
      ...
      for (var i = 0; i < testdata.length; i++) {
        test('$i', () {
          ...
          if (data.x.value > 0) {
            expect(
                ram[sp.value], equals(data.x.data + data.adr.value & 0xffff));
          } else {
            expect(ram[sp.value], equals(data.adr.value & 0xffff));
          }
        });
      }
    });
